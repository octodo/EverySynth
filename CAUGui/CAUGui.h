...
*/
extern "C" static pascal OSStatus CAUGuiControlHandler ( EventHandlerCallRef, EventRef, void*  );
...
*/
extern "C" static void TimerProc ( EventLoopTimerRef inTimer, void *inUserData );
